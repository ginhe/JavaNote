...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/62f23a8446464c44a2b2d7ca4bb379ff~tplv-k3u1fbpfcp-zoom-1.image)
...
redis+mysql和jar包是分别放在数据库服务器和应用服务器的，因此我们可以将redis监听在内网ip地址里，这样应用服务器里的程序所绑定的redis.host就是内网ip地址。
